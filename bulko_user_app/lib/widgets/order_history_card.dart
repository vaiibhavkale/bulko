...
class OrderHistoryCard extends StatefulWidget {
  ...
  OrderHistoryCard({this.order, this.analytics, this.observer, this.index}) : super();

  @override
  _OrderHistoryCardState createState() => _OrderHistoryCardState(order: order, analytics: analytics, observer: observer, index: index);
}
...
class _OrderHistoryCardState extends State<OrderHistoryCard> {
  ...
  _OrderHistoryCardState({this.order, this.analytics, this.observer, this.index});
  @override
