...
class CartScreen extends BaseRoute {
  CartScreen({super.analytics, super.observer, super.routeName = 'CartScreen'});
...
class _CartScreenState extends BaseRouteState {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        // Navigator.of(context).pop(); // Use this to go back
        return false;
      },
        ...
        builder: (value) => Scaffold(
          appBar: AppBar(
            automaticallyImplyLeading:
                false, // Remove back button on status bar
            title: Text(
          ...
          body: global.nearStoreModel != null
              ? _isDataLoaded
                  ? cartController.cartItemsList != null &&
                          cartController.cartItemsList!.cartList.length > 0
                      ? RefreshIndicator(
              ...
              Expanded(
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return SizedBox(
                          height:
                              100 * MediaQuery.of(context).size.height / 830,
