...
class AccountDrawer extends StatelessWidget {
              ...
              child: Container(
                ...
                child: FutureBuilder(
                  builder: (context, snapshot) {
                    ...
                    return Text(locale.hey! + ', ' + '${snapshot.data}', style: TextStyle(color: Colors.white, fontSize: 22,));
                  },
  ...
  ListTile buildListTile(BuildContext context, IconData icon, String text, Function onTap) {
    ...
    return ListTile(
      ...
      title: Text(text.toUpperCase(), style: theme.textTheme.headline6!.copyWith(fontSize: 18, letterSpacing: 0.8).copyWith(color: Colors.white)),
...
class LogoutTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: Text(locale.logout!.toUpperCase(), style: theme.textTheme.headline6!.copyWith(fontSize: 18, letterSpacing: 0.8).copyWith(color: Colors.white)),
      onTap: () {
        showDialog(
            context: context,
